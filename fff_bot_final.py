#!/usr/bin/env python3
"""
FFF-Bot envía mensajes cada 10 segundos usando Gemma2 - VERSIÓN FINAL FUNCIONAL
"""
...
def send_messages_every_10_seconds():
    """Enviar mensajes cada 10 segundos usando form-data"""
    ...
    prompts = [
        ...
        "Sigamos trabajando con energía"
    ]
    
    print("=== FFF-BOT CON GEMMA2 - ENVIANDO CADA 10 SEGUNDOS ===")
        ...
        while True:
            try:
                ...
                if gemma_response.status_code == 200:
                    ...
                    if message_content:
                        # Enviar a Zulip usando form-data (el formato que funciona)
                        zulip_data = {
                            "type": "stream",
                            "to": stream,
                            "topic": "chat",
                        ...
                        response = requests.post(
                            ...
                            data=zulip_data,  # Usar data en lugar de json
                            auth=auth,
                            verify=False,
                            timeout=10
                        )
                        ...
                        if response.status_code == 200:
                            ...
                            print(f"  Mensaje #{message_count} enviado a #{stream} (ID: {result.get('id')})")
                        else:
